...
#include "RCVerbMessageHelpers.h"
...
#include UE_INLINE_GENERATED_CPP_BY_NAME(RCVerbMessageHelpers)

//////////////////////////////////////////////////////////////////////
// FRCVerbMessage

FString FRCVerbMessage::ToString() const
{
	FString HumanReadableMessage;
	FRCVerbMessage::StaticStruct()->ExportText(/*out*/ HumanReadableMessage, this, /*Defaults=*/ nullptr, /*OwnerObject=*/ nullptr, PPF_None, /*ExportRootScope=*/ nullptr);
...
APlayerState* URCVerbMessageHelpers::GetPlayerStateFromObject(UObject* Object)
{
...
APlayerController* URCVerbMessageHelpers::GetPlayerControllerFromObject(UObject* Object)
{
	if (APlayerController* PC = Cast<APlayerController>(Object))
	{
		return PC;
...
FGameplayCueParameters URCVerbMessageHelpers::VerbMessageToCueParameters(const FRCVerbMessage& Message)
{
...
FRCVerbMessage URCVerbMessageHelpers::CueParametersToVerbMessage(const FGameplayCueParameters& Params)
{
	FRCVerbMessage Result;
