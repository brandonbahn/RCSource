...
#include "RCRangedWeaponInstance.generated.h"

/**
 * A piece of equipment representing a ranged weapon spawned and applied to a pawn
 */
UCLASS()
class REDCELL_API URCRangedWeaponInstance : public URCWeaponInstance, public IRCAbilitySourceInterface
{
	GENERATED_BODY()
	
public:
    URCRangedWeaponInstance(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
