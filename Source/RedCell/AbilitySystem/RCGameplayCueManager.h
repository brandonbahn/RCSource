...
#include "RCGameplayCueManager.generated.h"
...
/**
 * URCGameplayCueManager
 *
 * Game-specific manager for gameplay cues
 */
UCLASS()
class URCGameplayCueManager : public UGameplayCueManager
{
	GENERATED_BODY()

public:
	URCGameplayCueManager(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());

	static URCGameplayCueManager* Get();
