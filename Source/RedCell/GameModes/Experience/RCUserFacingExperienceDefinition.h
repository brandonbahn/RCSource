...
#include "RCUserFacingExperienceDefinition.generated.h"
...
class URCUserFacingExperienceDefinition : public UPrimaryDataAsset
{
	GENERATED_BODY()
...
public:
	...
	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category=Experience, meta=(AllowedTypes="RCExperienceDefinition"))
