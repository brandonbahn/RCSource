...
#include UE_INLINE_GENERATED_CPP_BY_NAME(RCExperienceDefinition)

#define LOCTEXT_NAMESPACE "RedCellSystem"

URCExperienceDefinition::URCExperienceDefinition()
{
}

#if WITH_EDITOR
EDataValidationResult URCExperienceDefinition::IsDataValid(FDataValidationContext& Context) const
{
...
void URCExperienceDefinition::UpdateAssetBundleData()
{
