...
#include "RCHUDLayout.generated.h"

class UCommonActivatableWidget;
class UObject;
class URCControllerDisconnectedScreen;
 ...
 */
UCLASS(Abstract, BlueprintType, Blueprintable, Meta = (DisplayName = "RedCell HUD Layout", Category = "RedCell|HUD"))
class URCHUDLayout : public URCActivatableWidget
{
	GENERATED_BODY()

public:

	URCHUDLayout(const FObjectInitializer& ObjectInitializer);
...
protected:
	...
	*/
	...
	TSubclassOf<URCControllerDisconnectedScreen> ControllerDisconnectedScreen;
